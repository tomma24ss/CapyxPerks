...
from models import User, Product, ProductVariant, InventoryLot, CreditLedger, UserRole, CreditType
...
def seed_database():
    ...
    try:
        ...
        print(f"   - Employee: john.doe@company.com")
        print(f"   - Senior: jane.smith@company.com")
